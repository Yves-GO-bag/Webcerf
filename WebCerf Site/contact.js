...
contactForm.addEventListener("submit", (e) => {
    ...
    const inputs = [contactFirstName, contactLastName, contactPhone, contactEmail, contactCompany, contactWebsite, contactMessage];
    ...
    if (allValid) {
        ...
        contactForm.reset(); // clears all input values
